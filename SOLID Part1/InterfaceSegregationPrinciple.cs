...
namespace SOLID_code_examples
{
    ...
    public class FullTimeEmployee : IWorker
    {
        ...
        public float CalculateWorkedSalary() => throw new NotImplementedException(); //unused method
    }
    ...
    public class ContractEmployee : IWorker
    {
        ...
        public float HourlyRate { get; set; }
        public float HoursInMonth { get; set; }
        public float CalculateNetSalary() => throw new NotImplementedException(); //unused method
